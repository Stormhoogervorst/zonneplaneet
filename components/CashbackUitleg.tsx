...
/* Iconen zijn stand-ins tot de rijen inhoudelijk bekend zijn.
   TODO: vervang titels, teksten en iconen als de cashback-actie vaststaat. */
const rijen = [
  {
    titel: "TODO",
...
export function CashbackUitleg() {
  return (
    <Rijenlijst eyebrow="TODO" id="cashback-uitleg" kop="TODO" rijen={rijen} />
  );
}
