...
/*
 * Deze sectie wijkt bewust af van de rest van de site: scherpe hoeken in plaats
 * van radius en geen pil-vormen. Neem dit patroon niet over in andere secties.
 */

function ZonnepaneelIcoon() {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 72 72"
...
/*
 * TODO: Het blok "Ik ben lid van een vereniging" heeft nog geen `href`. Het ziet
 * eruit als de andere blokken, maar is nog niet klikbaar. Zet de bestemming erop
 * zodra die er is; de opmaak verandert dan niet.
 */
const keuzeblokken: Keuzeblok[] = [
  {
    id: "keuze-lid",
    ...
    <section aria-labelledby="kies-onderdeel" className="bg-vlak py-24">
      <div className="mx-auto max-w-[1440px] px-8 md:px-16">
        ...
        <div className="grid gap-3 sm:grid-cols-2 md:gap-[2px] lg:grid-cols-3">
          {keuzeblokken.map(({ id, titel, beschrijving, href, Icoon }) => {
            const inhoud = (
              <>
                <span
                  aria-hidden="true"
