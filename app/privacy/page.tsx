  ...
  return (
    <main className="mx-auto max-w-2xl px-5 py-12">
      ...
      <section aria-labelledby="referral" className="mt-12">
        ...
        <p className="mt-4">
          Via het referralformulier kan iemand jouw voornaam, achternaam en
          telefoonnummer doorgeven, plus waar jij mogelijk interesse in hebt en
          een eventuele opmerking. We slaan die gegevens op samen met de naam,
          het e-mailadres en het telefoonnummer van de persoon die jou
          aandraagt.
        </p>
        <p className="mt-4">
          We nemen contact met je op, zodat je weet hoe we aan je gegevens
